                            ...
                            <div className="card1-body">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className='row'>
                                        ...
                                        <div className="col-md-6 mb-3">
                                            <label htmlFor="aadhaar" className="form-label">Aadhar ID</label>
                                            <input type="text" className="form-control" id="aadhaar" name="aadhaar" value={formData.aadhaar} onChange={handleChange} required />
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <label htmlFor="birthDate" className="form-label">birthDate</label>
                                            <input type="date" className="form-control" id="birthDate" name="birthDate" onBlur={handleBlur} required/>
                                        </div>
                                        ...
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <input type="text" className="form-control" id="blood" name="blood" value={formData.blood} onChange={handleChange} required />
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <label htmlFor="remark" className="form-label">Remark(If any)</label>
                                            <input type="text" className="form-control" id="remark" name="remark" value={formData.remark} onChange={handleChange} />
                                        </div>
                                        ...
                                        <div className="col-md-6 mb-3">
                                            ...
                                            />
                                            <label className="form-check-label" htmlFor="exampleCheck1">Is New Patient?</label>
                                        </div>
