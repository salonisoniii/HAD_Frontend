                ...
                <form onSubmit={handleSubmit}>
                  <div className='row'>
                    ...
                    <div className="col-md-6 mb-3">
                      ...
                      <select type="text" className="form-select" id="bloodGroup" name="blood" value={formData.bloodGroup} onChange={handleChange} required >
                    ...
                    <button type="submit" className="btn btn-primary btn-ph" style={{width : '30%' , marginLeft:'30%'}}>Submit</button>
                  </div>
                </form>
              </div>
            </div>
